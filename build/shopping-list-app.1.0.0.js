...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	    ...
	    function addListName(name) {
	        ...
	        //add list name
	        $('.listNames ul').append('<li><label for=""><input type="radio" name="listName" ' + 'value="' + name + '"checked="true" class="hidden"> ' + name + '</label><i class="fa ' + 'fa-times delete" aria-hidden="true"></i></li>').find('li:last').addClass('highlight', this.checked);
