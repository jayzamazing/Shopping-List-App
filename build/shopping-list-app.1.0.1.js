...
/***/ function(module, exports, __webpack_require__) {
	...
	$('document').ready(function (event) {
	    ...
	    promiseLogging(parseList(shopLists, addListName, event)).then(promiseLogging(parseList(listItems, addItem, event))).then(promiseLogging(parseChecked(checked)));
	    ...
	    function addItem(name) {
	        ...
	        $('.listItems ul').append('<li><label for="" class="checkListName">' + '<input type="checkbox" value="' + name + '" class="hidden"> ' + name + '</label><i class="fa fa-times delete" aria-hidden="true"></i></li>');
	        //clear field
	        $('#itemName').val('');
	    }
	    /*
	    ...
	    function addListName(name, event) {
	        ...
	        //add list name
	        $('.listNames ul').append('<li><label for=""><input type="radio" name="listName" ' + 'value="' + name + '" checked class="hidden"> ' + name + '</label><i class="fa ' + 'fa-times delete" aria-hidden="true"></i></li>').find('li:last').addClass('highlight', event.checked);
...
/***/ }
/******/ ]);
//# sourceMappingURL=shopping-list-app.1.0.1.js.map